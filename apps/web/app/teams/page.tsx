...
function buildDispatchTeamsPath(searchParams: Readonly<URLSearchParams> | null) {
...
function TeamsPageContent() {
  ...
  const targetPath = useMemo(
    () => (capabilities.canAccessDispatch ? buildDispatchTeamsPath(searchParams) : fallback.href),
