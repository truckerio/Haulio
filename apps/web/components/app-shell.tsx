...
const roleRoutes: Record<string, string[]> = {
  ...
  HEAD_DISPATCHER: ["/today", "/dashboard", "/loads", "/dispatch", "/teams", "/billing/readiness", "/profile"],
  DISPATCHER: ["/today", "/dashboard", "/loads", "/dispatch", "/billing/readiness", "/profile"],
  BILLING: ["/today", "/dashboard", "/loads", "/billing", "/billing/readiness", "/settlements", "/profile"],
  DRIVER: ["/driver"],
};
